...
class Test_dzq_from_du_and_h:
    def test_given_situations_resulting_in_valid_values_when_dzq_from_du_and_h_then_all_values_returned_are_expected_values(
        self,
    ):
    ...
    def test_given_situations_resulting_in_nans_when_dzq_from_du_and_h_then_all_values_returned_are_nan(
        self,
    ):
...
class Test_main_computation:
    def test_given_varying_values_when_main_computation_then_expect_returned_values_are_in_range_of_expected_values(
        self,
    ):
        ...
        zgem = numpy.array(
            [0.25252016129032256, 0.5871975806451613, 0.5871975806451613, 1.0, 1.0]
        )
        zmax = numpy.array(
            [0.6048387096774194, 0.9274193548387097, 0.9274193548387097, 1.0, 1.0]
        )
        zmin = numpy.array(
            [0.012096774193548387, 0.09274193548387097, 0.09274193548387097, 1.0, 1.0]
        )
        ...
        zdzb = [
            ...
            numpy.array(
                [0.012096774193548387, 0.8185483870967742, 0.8185483870967742, 1.0, 1.0]
            ),
        ]

        zgemc, zmaxc, zminc, dzb = dfastmi.kernel.core.main_computation(
            [dzq1, dzq2, dzq3], T, rsigma
        )

        self.print_values_floatmode_unique(
            zgem, zgemc, zmax, zmaxc, zmin, zminc, zdzb, dzb
        )
    ...
    def test_given_one_miss_value_when_main_computation_then_expect_returned_values_are_in_range_of_expected_values(
        ...
        zgem = numpy.array(
            [0.25252016129032256, 0.5871975806451613, 0.5871975806451613, 1.0, 0.0]
        )
        zmax = numpy.array(
            [0.6048387096774194, 0.9274193548387097, 0.9274193548387097, 1.0, 0.0]
        )
        zmin = numpy.array(
            [0.012096774193548387, 0.09274193548387097, 0.09274193548387097, 1.0, 0.0]
        )
        ...
        zdzb = [
            ...
            numpy.array(
                [0.012096774193548387, 0.8185483870967742, 0.8185483870967742, 1.0, 0.0]
            ),
        ]
    ...
    def test_given_one_miss_value_stagnant_t_when_main_computation_then_expect_returned_values_are_in_range_of_expected_values(
        ...
        zgem = numpy.array(
            [0.1693548387096774, 0.45967741935483875, 0.45967741935483875, 0.75, 0.0]
        )
        zmax = numpy.array(
            [
                0.6048387096774194,
    ...
    def test_given_stagnant_t_when_main_computation_then_expect_returned_values_are_in_range_of_expected_values(
        self,
    ):
        dzq1 = numpy.array([0.0, 0.0, 0.0, 1.0, 1.0])
        dzq2 = numpy.array([0.0, 1.0, 1.0, 1.0, 1.0])
        ...
        zgem = numpy.array(
            [0.24489795918367346, 0.24489795918367346, 0.24489795918367346, 0.75, 0.75]
        )
        zmax = numpy.array(
            [0.8163265306122449, 0.8163265306122449, 0.8163265306122449, 1.0, 1.0]
        )
        zmin = numpy.array(
            [0.08163265306122451, 0.08163265306122451, 0.08163265306122451, 1.0, 1.0]
        )
    ...
    def test_given_dummy_when_main_computation_then_expect_returned_values_are_in_range_of_expected_values(
        self,
    ):
        dzq1 = numpy.array([0.0, 0.0, 0.0, 1.0, 1.0])
        ...
        zgem = numpy.array(
            [0.26764112903225806, 0.610383064516129, 0.610383064516129, 1.25, 1.25]
        )
        zmax = numpy.array(
            [
                0.6048387096774194,
    ...
    def test_given_stagnant_t_one_miss_value_one_dummy_when_main_computation_then_expect_returned_values_are_in_range_of_expected_values(
        ...
        zgem = numpy.array(
            [0.1844758064516129, 0.4828629032258065, 0.4828629032258065, 1.0, 0.0]
        )
        zmax = numpy.array(
            [0.6048387096774194, 0.9274193548387097, 0.9274193548387097, 1.0, 0.0]
        )
    ...
    def print_values_floatmode_unique(
        self, zgem, zgemc, zmax, zmaxc, zmin, zminc, zdzb, dzb
    ):
        """
...
class Test_celerity_calculation:
    ...
    def test_given_first_element_Of_celq_is_smaller_than_q_when_get_celerity_then_return_first_element_of_celc(
        self,
    ):
    ...
    def test_given_first_element_Of_celq_is_bigger_than_q_when_get_celerity_then_return_first_element_of_celc(
        self,
    ):
    ...
    def test_given_q_bigger_than_any_celq_when_get_celerity_then_return_last_element_of_celc(
        self,
    ):
...
class Test_relax_factors_calculation:
    def test_given_single_value_for_calculation_when_relax_factors_then_return_rsigma_value_between_expected_values(
        self,
    ):
        Q = [2]
        T = [0.0005]
    ...
    def test_given_multiple_values_for_calculation_when_relax_factors_then_return_rsigma_values_between_expected_values(
        self,
    ):
        Q = [2, 2]
        T = [0.0005, 1.0]
    ...
    def test_given_multiple_values_for_calculation_with_different_width_when_relax_factors_then_return_rsigma_varying_values_between_expected_values(
        self,
    ):
        Q = [2, 2]
        T = [0.0005, 1.0]
    ...
    def test_given_q_same_as_q_stagnant_when_relax_factors_then_return_rsigma_values_of_1(
        self,
    ):
        Q = [2, 2, 2, 2]
        T = [5, 5, 5, 5]
    ...
    def test_given_q_smaller_than_q_stagnant_when_relax_factors_then_return_rsigma_values_of_1(
        self,
    ):
        Q = [2, 2, 2, 2]
        T = [5, 5, 5, 5]
...
class Test_estimate_sedimentation_length:
    ...
    def test_given_tmi_and_celerity_when_estimate_sedimentation_length_then_return_expected_length(
        self, tmi, celerity, expected_length
    ):
