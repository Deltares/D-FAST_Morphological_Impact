...
\def\NVOMaasFigDir{../examples/c02 - Maas/figures/}
...
De tool ondersteunt op dit moment de riviertakken waarvoor in het RBK maatgevende schipafmetingen zijn gedefinieerd. Dit betreft:
...
\begin{figure*}[!h]
\centering
\includegraphics[width=\textwidth]{\NVOMaasFigDir/profile0_location.png}
...
\begin{figure*}[!h]
\centering
\includegraphics[width=\textwidth]{\NVOMaasFigDir/profile1_location.png}
...
\begin{figure*}[!h]
\centering
\includegraphics[width=\textwidth]{\NVOMaasFigDir/C2_difference_Froude.png}
...
\begin{figure*}[!h]
\centering
\includegraphics[width=\textwidth]{\NVOMaasFigDir/C2_difference_Froude_wateruplift_bedchange.png}
\caption{Verschil in Froude getallen tussen plansituatie en referentie, met correcties (S2100)}
\label{fig:NVO_Froude_diff}
\end{figure*}
