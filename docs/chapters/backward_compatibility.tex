...
The response of the main channel is represented here by a bed level change $\Delta z_b$ \unitbrackets{\SI{}{\metre}} (raise or lowering) which is small relative to the local water depth.
...
\item minimum value \unitbrackets{\SI{}{\metre}} at the end of the low flow season
...
\item transitional value \unitbrackets{\SI{}{\metre}} at the end of the transition block before the flood period
...
\item year-averaged value \unitbrackets{\SI{}{\metre}}
...
Optionally, the same block may also contain \keyw{QThreshold}, \keyw{QBankfull} and \keyw{UCrit} values representative for this particular intervention if they differ from those typical for the selected reach.
