...
class Test_a_configuration_checker:
    ...
    def given_correct_branch_but_invalid_reach_when_get_reach_then_throw_lookup_exception(
        self,
...
class Test_configuration_checker:
    ...
    def given_version_2_when_check_configuration_then_return_false(
        self, configuration_checker: ConfigurationChecker, rivers: RiversObject
    ):
