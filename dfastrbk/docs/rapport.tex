...
\begin{itemize}
	...
	\item Afstemming met de RWS klankbordgroep, bestaande uit Arjan Sieben (RWS Water, Verkeer en Leefomgeving (WVL)), William de Lange (RWS WVL), Joey Ewals (RWS Zuid-Nederland (ZN)), Emiel Kater (RWS Oost-Nederland (ON)), Mirjam Flierman (RWS West-Nederland Zuid (WNZ))
\end{itemize}
...
\begin{enumerate}
	...
	\end{requirement}
	\begin{testmethod}
	Om resultaten langs de raai-km van de rivier te plotten, moet in het configuratiebestand voor het keyword \texttt{RiverKM} onder \texttt{General} een XYC bestand \citep[zie]{dfastmi_usermanual} met raai-km's worden opgegeven.
	\end{testmethod}
...
\begin{itemize}
	...
	\item De berekening van dwarsstroomdebiet is afhankelijk van een correcte rivierkilometrering, dus daar waar verspringingen plaatsvinden (bv. op de IJssel tussen rkm 905 en 910) moet de uitvoer als onnauwkeurig worden beschouwd.
	...
	\item Voor andere schipafmetingen, bv. de recreatievaart, is de tool nog niet getest. Voor het modelleren van de stroming met D-HYDRO geldt de richtlijn dat de resolutie van het rekenrooster rond de ingreep in langsrichting fijner moet zijn dan de lengte van het schip.
\end{itemize}
...
Op de Boven-Rijn en Waal wordt de dwarsstromingsnorm op tientallen locaties overschreden, verdeeld over een afstand van ongeveer 100 km. Nergens komt een dwarsstroomdebiet van meer dan 50 $m^3/s$ voor, dus overal geldt de norm voor dwarsstroomsnelheid van 0.3 $m/s$. Een overzicht van alle overschrijdingen is gegeven in Tabel \ref{tab:BovenrijnWaal_dwarsstroming}: voor S4000 zijn er in totaal 20 overschrijdingen, voor S6000 zijn het er 32, en voor S8000 zijn het er 30. Het grootste dwarsstroomdebiet is 25.8 $m^3/s$ voor S4000 (rkm 918.264-918.5), 24.0 $m^3/s$ voor S6000 (rkm 910.105-910.363) en 25.9 $m^3/s$ voor S8000 (rkm 910.105-910.374). Op deze laatste locatie ligt de samenkomst van een geul van de Kaliwaal met de Waal (zie profiel 4).
...
Op de IJssel wordt de dwarsstromingsnorm op enkele locaties overschreden, verdeeld over een afstand van ongeveer 128 km. Nergens komt een dwarsstroomdebiet van meer dan 50 $m^3/s$ voor, dus overal geldt de norm voor dwarsstroomsnelheid van 0.3 $m/s$. Een overzicht van alle overschrijdingen is gegeven in Tabel \ref{tab:IJssel_dwarsstroming}: voor S4000 zijn er 3 overschrijdingen, voor S6000 zijn het er 11, en voor S8000 zijn het er 20. Het grootste dwarsstroomdebiet is 11.0 $m^3/s$ voor S4000 (rkm 1001.637-1001.723), 23.1 $m^3/s$ voor S6000 (rkm 984.358-984.451) en 27.3 $m^3/s$ voor S8000 (rkm 984.358-984.451). Op deze laatste locatie ligt de samenkomst van de Vreugderijkerwaard met de IJssel. 
...
\insertdoublefigure{\RijnFigDir//IJssel/figures/C3_profile6_transverse_discharge.png}{\RijnFigDir//IJssel/figures/profile6_location.png}{Dwarsstroming op de IJssel voor S8000 profiel 6}
...
\insertdoublefigure{\RijnFigDir//IJssel/figures/C3_profile13_transverse_discharge.png}{\RijnFigDir//IJssel/figures/profile13_location.png}{Dwarsstroming op de IJssel voor S8000 profiel 13}
...
\FloatBarrier
\gensection{\isreport}{4}{Nederrijn-Lek en Pannerdens Kanaal}
Op de Nederrijn-Lek en het Pannerdens Kanaal wordt de dwarsstromingsnorm op enkele locaties overschreden, verdeeld over een afstand van ongeveer 100 km. Nergens komt een dwarsstroomdebiet van meer dan 50 $m^3/s$ voor, dus overal geldt de norm voor dwarsstroomsnelheid van 0.3 $m/s$. Een overzicht van alle overschrijdingen is gegeven in Tabel \ref{tab:NederrijnLek_dwarsstroming}: voor S4000 zijn er 7 overschrijdingen, voor S6000 zijn het er 19, en voor S8000 zijn het er 28. Het grootste dwarsstroomdebiet is 6.3 $m^3/s$ voor S4000 (rkm 922.204-922.31), 11.6 $m^3/s$ voor S6000 (rkm 899.771-899.921) en 13.2 $m^3/s$ voor S8000 (rkm 924.672-924.849). Op deze laatste locatie ligt het uiterwaardengebied de Waarden van Gravenbol.
...
\insertdoublefigure{\RijnFigDir//NederrijnLek/figures/C3_profile7_transverse_discharge.png}{\RijnFigDir//NederrijnLek/figures/profile7_location.png}{Dwarsstroming op de Nederrijn-Lek voor S8000 profiel 7}
...
\FloatBarrier
\gensection{\isreport}{3}{Dwarsstroming}
Op de Maas wordt de dwarsstromingsnorm op tientallen locaties overschreden, verdeeld over een afstand van ongeveer 250 km. Nergens komt een dwarsstroomdebiet van meer dan 50 $m^3/s$ voor, dus overal geldt de norm voor dwarsstroomsnelheid van 0.3 $m/s$. Op de rivieras wordt de norm op 12 locaties overschreden, zie Tabel \ref{tab:Maas_rivieras_dwarsstroming}. 
...
\FloatBarrier
Een overzicht van alle overschrijdingen op de randen van de vaarweg is gegeven in Tabel \ref{tab:Maas_dwarsstroming}: voor S1700 zijn er in totaal 61 overschrijdingen, voor S2100 zijn het er 207, en voor S2500 zijn het er 91. De grootste overschrijding vindt plaats tussen de Sint Servaasbrug en de Wilhelminabrug rond rkm 13.4. Het grootste dwarsstroomdebiet is 18.5 $m^3/s$ voor S1700 (rkm 70.698-70.89), 27.7 $m^3/s$ voor S2100 (rkm 73.289-73.457) en 20.5 $m^3/s$ voor S2500 (rkm 73.289-73.457). Op deze laatste locatie ligt de Maas tussen de Gerelingsplas en de Oolderplas. Onderstaand figuur toont de dwarsstroomsnelheid op deze locatie.

\input{\MaasFigDir/output/analysis_0.3.tex}

\insertdoublefigure{\MaasFigDir//figures/C2_profile29_transverse_discharge.png}{\MaasFigDir//figures/profile29_location.png}{Dwarsstroming op de Maas voor S2100 profiel 29}
...
\begin{enumerate}
	...
	\item Verbetering van het normprofiel in de Maas ten behoeve van beoordeling van dwarsstroom- en ijsafvoereffecten van ingrepen.
\end{enumerate}
...
Om de rekentool te installeren moet onderstaande stappen gevolgd worden:
\begin{enumerate}
