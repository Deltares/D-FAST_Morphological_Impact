...
\item Users must be able to run the analysis based on D-Flow FM results.
...
\item The should read relevant data directly from D-Flow FM map-files instead of intermediate XYZ files as required by WAQMORF for SIMONA results.

\item The input file could use the ini-format consistent with D-Flow FM input files.
