...
class Test_AnalyserWaqua:
    ...
    def given_data_and_mocked_classes_with_missing_file_location_when_analyse_then_return_empty_output_data(
        self, display: bool, reduced_output: bool, old_zmin_zmax: bool
    ):
        """
        ...
        with (
            patch("dfastmi.batch.AnalyserWaqua.ApplicationSettingsHelper.log_text"),
            patch(
                "dfastmi.batch.AnalyserWaqua.ApplicationSettingsHelper.get_text"
            ) as mocked_get_text,
            patch(
                "dfastmi.batch.AnalyserWaqua.DataTextFileOperations.read_waqua_xyz"
            ) as mocked_read_waqua_xyz,
            patch(
                "dfastmi.batch.AnalyserWaqua.dfastmi.kernel.core.dzq_from_du_and_h"
            ) as mocked_kernel_core,
        ):
    ...
    def given_data_and_mocked_classes_when_analyse_then_return_expected_output_data(
        self, display: bool, reduced_output: bool, old_zmin_zmax: bool
    ):
        """
    ...
    def given_data_and_mocked_classes_with_tstag_above_zero_when_analyse_then_return_expected_output_data(
        self, display: bool, reduced_output: bool, old_zmin_zmax: bool
    ):
        """
