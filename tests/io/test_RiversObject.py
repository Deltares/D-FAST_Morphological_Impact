...
class Test_read_rivers():
    def test_read_rivers_01(self):
        ...
        rivers = dfastmi.io.RiversObject("tests/files/read_rivers_test.ini")
    ...
    def test_read_rivers_02(self):
        ...
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_rivers_test_no_version.ini")
    ...
    def test_read_rivers_03(self):
        ...
        """        
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_rivers_test_wrong_version.ini")
...
class Test_read_rivers2():    
    def test_read_rivers2_01(self):
        ...
        """
        print("current work directory: ", os.getcwd())
        rivers = dfastmi.io.RiversObject("tests/files/read_rivers_test_2_0_version.ini")
    ...
    def test_read_rivers2_02(self):
        ...
        self.maxDiff = None
        assert dfastmi.io.RiversObject("tests/files/read_riversv2_test.ini") == rivers
    ...
    def test_read_rivers2_03(self):
        ...
        """
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_riversv2_test_failing_CelerQ.ini") 
    ...
    def test_read_rivers2_04(self):
        ...
        """
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_riversv2_test_failing_HydroQ.ini") 
    ...
    def test_read_rivers2_05(self):
        ...
        """
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_riversv2_test_failing_HydroT.ini") 
    ...
    def test_read_rivers2_06(self):
        ...
        """
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_riversv2_test_failing_TideBC.ini") 
    ...
    def test_read_rivers2_07(self):
        ...
        """
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_riversv2_test_failing_cform.ini") 
    ...
    def test_read_rivers2_08(self):
        ...
        """
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_riversv2_test_failing_noPropQC.ini") 
    ...
    def test_read_rivers2_09(self):
        ...
        """
        with pytest.raises(Exception) as cm:
            dfastmi.io.RiversObject("tests/files/read_riversv2_test_failing_wrongcform.ini") 
