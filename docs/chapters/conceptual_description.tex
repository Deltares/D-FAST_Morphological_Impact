...
\end{equation}
%
where $i$ loops over the conditions for which the discharge $Q_i$ is larger than the discharge $Q_\text{stagnant}$ that marks the transition between stagnant conditions (lowered barriers) and normal flow (raised barriers).
