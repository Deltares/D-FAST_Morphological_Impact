...
\newline
\newline
\begin{tabular}{p{2.5cm}|l|p{8.5cm}}
...
Meuse (excluding Grensmaas) & Borgharen & steady state 750, 1300, 1700, 2100, 2500 \SI{}{\metre\cubed\per\second} and SD-run including the effect of flood wave attenuation (`topvervlakking') for 3200 \SI{}{\metre\cubed\per\second} \\
Grensmaas & Borgharen & steady state 50, 250, 500, 750, 1300, 1700, 2100, 2500 \SI{}{\metre\cubed\per\second} and SD-run including the effect of flood wave attenuation (`topvervlakking') for 3200 \SI{}{\metre\cubed\per\second}
\end{tabular}
\newline
\newline
...
See section 4.2 `De Lymen' in the \dfmi validation document for a discussion about the need for runs including flood wave attenuation for more discharge conditions.}.
