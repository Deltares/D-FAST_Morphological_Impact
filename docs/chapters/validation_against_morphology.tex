...
\autoref{Pannerden_mor} shows the results of a long-term (15 year) reference morphological simulation using Delft3D-FLOW (for details, see \citet{GiriJagers2022}) and the year-averaged equilibrium morphological impact as computed by \dfmi version 3.0.0.
