...
\dfastmi may be run in \emph{cli mode} backward compatible with WAQMORF: in this (legacy) mode the configuration for the analysis is obtained by asking the user questions via a command line interface which support simulation results from WAQUA only.
...
\section{rivers configuration file}\label{app-v1:rivers}
...
\section{analysis configuration file}\label{app-v1:config}
