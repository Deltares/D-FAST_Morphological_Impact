...
def analyse_and_report_dflowfm(
    ...
    """
    analyser = AnalyserDflowfm(display, report)
    missing_data, report_data = analyser.analyse(q_threshold, tstag, discharges, fraction_of_year, rsigma, slength, nwidth, ucrit, filenames, xykm, needs_tide, n_fields, tide_bc, old_zmin_zmax, outputdir, plotops)
