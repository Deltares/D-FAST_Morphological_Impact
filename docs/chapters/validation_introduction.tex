...
All figures have been created using QUICKPLOT unless indicated otherwise.

\section{History}

This document presents the results of the latest configuration.
The configuration may

\begin{itemize}
\item \dfmi 3.3.0 introduces a new version of the \file{Dutch\_rivers\_v3.ini} rivers configuration file.
The new configuration contains new celerities for all reaches.
The celerities influence the estimated impacted length and the bed level changes.
The results may differ slightly.
Previous results can be reproduced by the latest \dfmi version by using the old configuration file.
\end{itemize}