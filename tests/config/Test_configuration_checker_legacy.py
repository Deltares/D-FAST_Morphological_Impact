...
class Test_configuration_checker_legacy:
    ...
    def given_mode_specific_test_with_discharge_check_configuration_then_return_true(
        self,
        configuration_checker: ConfigurationCheckerLegacy,
        rivers: RiversObject,
        config: ConfigParser,
    ...
    def given_mode_DFLOWFM_MAP_with_empty_discharge_check_configuration_then_return_false(
        self,
        configuration_checker: ConfigurationCheckerLegacy,
        rivers: RiversObject,
        config: ConfigParser,
    ...
    def given_mode_WAQUA_export_without_discharge_check_configuration_then_return_false(
        self,
        configuration_checker: ConfigurationCheckerLegacy,
        rivers: RiversObject,
        config: ConfigParser,
    ...
    def given_mode_WAQUA_export_with_empty_discharge_check_configuration_then_return_false(
        self,
        configuration_checker: ConfigurationCheckerLegacy,
        rivers: RiversObject,
        config: ConfigParser,
