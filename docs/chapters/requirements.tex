...
The purpose of \dfastmi is to provide a first estimate of the bed level changes in the main channel if local interventions were to be implemented outside the main channel.
...
The non-functional requirements at the time of the development of \dfastmi 2.0 were:
